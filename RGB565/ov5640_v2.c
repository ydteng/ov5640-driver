...
static struct v4l2_subdev_ops ov5640_subdev_ops = {
	.core	= &ov5640_subdev_core_ops,	/* 上电/下电、（可选）寄存器读写调试等 */
	.video	= &ov5640_subdev_video_ops,	/* 管“视频流参数/制式/帧率”等更偏 video 的控制接口 */
	.pad	= &ov5640_subdev_pad_ops,	/* 用于 media controller / pad 格式协商：传感器“输出到 CSI 的数据格式、分辨率、帧间隔”等 */
};
...
static int ov5640_probe(struct i2c_client *client)
{
	...
	ov5640_power_down(0);	/* 0应该是代表上电，也就是退出掉电模式 */
